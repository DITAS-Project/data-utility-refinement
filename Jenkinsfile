    ...
    stages {
        ...
        stage('Image deploy') {
            ...
            steps {
                ...
                sh 'ssh -i /opt/keypairs/ditas-testbed-keypair.pem cloudsigma@31.171.247.162 sudo docker run -p 50002:8080 -d --name data-utility-refinement ditas/data-utility-refinement:latest'
            }
        }
    }
}
